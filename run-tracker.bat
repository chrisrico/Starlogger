@echo off
rem Launch the SC mission tracker on Windows. Run it in a terminal (or make a
...
setlocal
set "REPO=%~dp0"
if not defined SCMT_DATA_DIR set "SCMT_DATA_DIR=%LOCALAPPDATA%\sc-mission-tracker"
